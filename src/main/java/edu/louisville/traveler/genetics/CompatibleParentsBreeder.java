...
//
//public class CompatibleParentsBreeder extends Breeder {
//
//  CompatibleParentsBreeder(ParentSelector parentSelector, Map map, int maxGeneSequenceLength, double mutationChance) {
//    super(parentSelector, map, maxGeneSequenceLength, mutationChance);
//  }
//
//  @Override
//  public LivingTour breedMates() {
//
...
//    return this.breedParents(compatibleParent1, compatibleParent2);
//  }
//
